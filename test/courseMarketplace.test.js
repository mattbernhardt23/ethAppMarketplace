// You must name these contracts as such.
// It could also have a solidity extension
...
contract("CourseMarketplace", (accounts) => {
  ...
  let buyer = null;
  let courseHash = null;
  // Executes before our tests, so you can do some initialization and preparation of variables
  before(async () => {
  ...
  describe("Purchase the new course", () => {
    ...
    it("Can get get the purchased course hash by index", async () => {
      const index = 0;
